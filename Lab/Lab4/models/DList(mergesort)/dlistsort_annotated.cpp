...
template<class T> node<T> *DListsort<T>::ssort(int num, node<T> *firstnode, node<T> *lastnode, node<T> *outlastnode, node<T> *dummy)
{
    cout << "call ssort:\n";
    cout << "num = " << num << "\n";
    cout << "first = " << firstnode << " value: " << (*firstnode).getdata() << "\n";
    cout << "last = " << lastnode << " value: " << (*lastnode).getdata() << "\n";
    cout << "dummy = " << dummy << " value: " << (*dummy).getdata() << "\n";
    cout << "out = " << outlastnode << " value: " << (*outlastnode).getdata() << "\n\n";
    for (int c = num; c>0; --c)
    {
        node<T> *minnode;
...
{
    cout << "call add:\n";
    cout << "min = " << minadd << " value: " << (*minadd).getdata() << "\n";
    cout << "dummy = " << dummy << " value: " << (*dummy).getdata() << "\n";
    cout << "out = " << outlastnode << " value: " << (*outlastnode).getdata() << "\n\n";
...
template<class T> node<T> *DListsort<T>::msort(int num, node<T> *first, node<T> *last, int thr, node<T> *dummy, node<T> *outlastnode)
{
    cout << "call msort:\n";
    cout << "num = " << num << "\n";
    cout << "first = " << first << " value: " << (*first).getdata() << "\n";
    cout << "last = " << last << " value: " << (*last).getdata() << "\n";
    cout << "dummy = " << dummy << " value: " << (*dummy).getdata() << "\n";
    cout << "out = " << outlastnode << " value: " << (*outlastnode).getdata() << "\n\n";
    if (num <= thr)
    {
...
{
    cout << "call merge:\n";
    cout << "first1 = " << first1 << " value: " << (*first1).getdata() << "\n";
    cout << "last1 = " << last1 << " value: " << (*last1).getdata() << "\n";
    cout << "first2 = " << first2 << " value: " << (*first2).getdata() << "\n";
    cout << "last2 = " << last2 << " value: " << (*last2).getdata() << "\n";
    cout << "dummy = " << dummy << " value: " << (*dummy).getdata() << "\n";
    cout << "out = " << outlast << " value: " << (*outlast).getdata() << "\n\n";
    node<T> *temp;
